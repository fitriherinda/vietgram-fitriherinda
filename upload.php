...
if (isset($_POST["submit"])) {
    if (!tambahPhoto($_POST) > 0) {
        ...
        echo "<script>
            alert('Photo didn't uploaded yet');
            document.location.href = 'explore.php';
        </script>";
    }
}
    ...
    $file_tmp = $_FILES['url']['tmp_name'];
        ...
        if (in_array($ekstensi, $ekstensi_allowed) === true) {
            if ($ukuran < 1044070) {
                ...
                echo '<script>File is Too Big</script>';
            }
        } else {
            echo '<script>File Format is Denied!</script>';
    }
}
...
<body>
    ...
    <footer class="footer">
        ...
        <div class="footer__column">
            <span class="footer__copyright">© 2017 Vietgram by fitriherindaw</span>
        </div>
    </footer>
</body>
